...
struct qt_meta_stringdata_D3DWidget_t {
    QByteArrayData data[1];
    char stringdata[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_D3DWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_D3DWidget_t qt_meta_stringdata_D3DWidget = {
    {
...
const QMetaObject D3DWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_D3DWidget.data,
      qt_meta_data_D3DWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_D3DWidget.stringdata))
